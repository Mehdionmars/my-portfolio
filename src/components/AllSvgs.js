...
export const LinkedIn = (props) => {
  return (
    ...
    >
      <path
        fill={props.fill}
        d="M100.28 448H7.4V148.9h92.88zm-46.44-341.25C24.39 106.75 0 82.36 0 52.42a52.25 52.25 0 11104.5 0c0 29.94-24.39 54.33-54.65 54.33zM447.9 448h-92.88V302.4c0-34.77-12.48-58.5-43.76-58.5-23.87 0-38.08 16.06-44.36 31.55-2.29 5.57-2.87 13.33-2.87 21.13V448h-92.87s1.2-249.1 0-274.1h92.88v38.84c-.18.29-.43.59-.61.88h.61v-.88c12.35-19.02 34.43-46.18 83.73-46.18 61.2 0 107.1 39.84 107.1 125.44V448z"
      />
    </svg>
  );
};
